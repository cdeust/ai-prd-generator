...
/// OpenAI GPT-4V Vision implementation with retry logic and cost tracking
/// Uses GPT-4 with vision capabilities for mockup analysis
@available(iOS 15.0, macOS 12.0, *)
public final class OpenAIVisionAnalyzer: VisionAnalysisPort, Sendable {
    ...
    internal let errorMapper: OpenAIErrorMapper
    ...
    public init(
        ...
        self.errorMapper = OpenAIErrorMapper()
        self.validator = ResponseValidator()
        self.jsonParser = OpenAIJSONParser()
    ...
    private func createExecutor() -> OpenAIAnalysisExecutor {
    ...
    private func createProcessor() -> OpenAIResultProcessor {
        OpenAIResultProcessor(
            telemetry: telemetry,
            logger: logger,
    ...
    public var providerName: String { "OpenAI GPT-4V" }
