...
struct GeminiStreamingParser: Sendable {
    /// Parse streaming chunk from Gemini API
    func parseChunk(_ line: String) throws -> GeminiStreamResponse? {
