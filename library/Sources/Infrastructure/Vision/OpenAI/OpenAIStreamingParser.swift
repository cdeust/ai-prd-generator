...
/// Parser for OpenAI streaming responses
struct OpenAIStreamingParser: Sendable {
    /// Parse streaming chunk from OpenAI API
    func parseChunk(_ line: String) throws -> OpenAIStreamResponse? {
