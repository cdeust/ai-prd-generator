...
public struct Configuration: Sendable {
    ...
    public static func fromEnvironment() -> Configuration {
        ...
        let licenseTier = parseLicenseTier()
    ...
    private static func parseLicenseTier() -> LicenseTier {
        // Use LicenseValidator for comprehensive license resolution
        // Priority: LICENSE_KEY > LICENSE_TIER > license file > free
        return LicenseValidator.resolveLicenseTier()
    }
